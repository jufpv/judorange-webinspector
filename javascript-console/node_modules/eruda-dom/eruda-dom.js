...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["erudaDom"] = factory();
	else
		root["erudaDom"] = factory();
...
module.exports = function (eruda) {
  var _eruda$util = eruda.util,
      ...
      $ = _eruda$util.$,
      toArr = _eruda$util.toArr;

  var Dom = function (_eruda$Tool) {
    (0, _inherits3.default)(Dom, _eruda$Tool);
    ...
    function Dom() {
      ...
      _this.name = 'dom';
      _this._style = evalCss(__webpack_require__(99));
      _this._isInit = false;
      _this._htmlTagTpl = __webpack_require__(101);
      _this._textNodeTpl = __webpack_require__(118);
      _this._selectedEl = document.documentElement;
      _this._htmlCommentTpl = __webpack_require__(119);
      return _this;
    }
    ...
    (0, _createClass3.default)(Dom, [{
      ...
      value: function init($el, container) {
        (0, _get3.default)(Dom.prototype.__proto__ || (0, _getPrototypeOf2.default)(Dom.prototype), 'init', this).call(this, $el);
        this._container = container;
        $el.html(__webpack_require__(120)());
      ...
      key: 'show',
      value: function show() {
        (0, _get3.default)(Dom.prototype.__proto__ || (0, _getPrototypeOf2.default)(Dom.prototype), 'show', this).call(this);
      ...
      key: 'hide',
      value: function hide() {
        (0, _get3.default)(Dom.prototype.__proto__ || (0, _getPrototypeOf2.default)(Dom.prototype), 'hide', this).call(this);
      }
    }, {
      key: 'select',
      ...
      value: function destroy() {
        (0, _get3.default)(Dom.prototype.__proto__ || (0, _getPrototypeOf2.default)(Dom.prototype), 'destroy', this).call(this);
      ...
      value: function _bindEvent() {
        ...
        this._$el.on('click', '.eruda-inspect', function () {
          _this2._setElement(_this2._selectedEl);
      ...
      value: function _setElement(el) {
        var elements = this._container.get('elements');
        if (!elements) return;
      ...
      key: '_renderChildren',
      value: function _renderChildren(node, $container) {
        var _this3 = this;
        ...
        each(children, function (child) {
          return _this3._renderChild(child, container);
        });
      }
    }, {
      key: '_renderChild',
      value: function _renderChild(child, container) {
        var _this4 = this;
        ...
        if (child.nodeType === child.ELEMENT_NODE) {
          var childCount = child.childNodes.length;
          var expandable = childCount > 0;
          var data = (0, _extends3.default)({}, getHtmlTagData(child), {
            hasTail: expandable
          });
          var hasOneTextNode = childCount === 1 && child.childNodes[0].nodeType === child.TEXT_NODE;
          if (hasOneTextNode) {
          ...
          $tag.html(this._textNodeTpl({
            value: value
          }));
        } else if (child.nodeType === child.COMMENT_NODE) {
          var _value = child.nodeValue;
          if (_value.trim() === '') return;

          $tag.html(this._htmlCommentTpl({
            value: _value
          }));
        } else if (child.nodeType === 'END_TAG') {
          isEndTag = true;
          child = child.node;
          $tag.html('<span class="eruda-html-tag" style="margin-left: -12px;">&lt;<span class="eruda-tag-name">/' + child.tagName.toLocaleLowerCase() + '</span>&gt;</span><span class="eruda-selection"></span>');
        } else {
          return;
        }
        var $children = createEl('ul');
        ...
        if ($tag.hasClass('eruda-expandable')) {
          var open = function open() {
            $tag.html(_this4._htmlTagTpl((0, _extends3.default)({}, getHtmlTagData(child), {
              hasTail: false
            })));
            $tag.addClass('eruda-expanded');
            _this4._renderChildren(child, $children);
          };
          ...
          $tag.on('click', '.eruda-toggle-btn', function (e) {
            e.stopPropagation();
            toggle();
          });
          erudaDom = {
        ...
        var select = function select() {
          _this4._$el.find('.eruda-selected').rmClass('eruda-selected');
          $tag.addClass('eruda-selected');
          _this4._selectedEl = child;
          _this4._setElement(child);
        };
        $tag.on('click', select);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(34)(Function.call, __webpack_require__(33).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// module
exports.push([module.i, ".eruda-dev-tools .eruda-tools .eruda-dom {\n  padding-bottom: 40px; }\n  .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree {\n    overflow-y: auto;\n    -webkit-overflow-scrolling: touch;\n    overflow-x: hidden;\n    word-wrap: break-word;\n    padding: 10px 10px 10px 25px;\n    font-size: 12px;\n    height: 100%;\n    font-family: Consolas, Lucida Console, Monaco, MonoSpace;\n    cursor: default; }\n    .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree * {\n      -webkit-user-select: text;\n         -moz-user-select: text;\n          -ms-user-select: text;\n              user-select: text; }\n    .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item {\n      line-height: 16px;\n      min-height: 16px;\n      position: relative;\n      z-index: 10; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-toggle-btn {\n        position: absolute;\n        display: block;\n        width: 12px;\n        height: 12px;\n        left: -12px;\n        top: 2px; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-selection {\n        position: absolute;\n        display: none;\n        left: -10000px;\n        right: -10000px;\n        top: 0;\n        bottom: 0;\n        z-index: -1;\n        background: #2196f3; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-selected {\n        color: #fff !important; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-selected span {\n          color: #fff !important; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-selected.eruda-expandable:before {\n          border-left-color: #fff; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-selected.eruda-expandable.eruda-expanded:before {\n          border-top-color: #fff;\n          border-left-color: transparent; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-selected .eruda-selection {\n          display: block; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-html-tag {\n        color: #a894a6; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-html-tag .eruda-tag-name {\n          color: #881280; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-html-tag .eruda-attribute-name {\n          color: #994500; }\n        .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-html-tag .eruda-attribute-value {\n          color: #1a1aa6; }\n          .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-html-tag .eruda-attribute-value.eruda-attribute-underline {\n            text-decoration: underline; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item .eruda-html-comment {\n        color: #236e25; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-expandable:before {\n        content: '';\n        width: 0;\n        height: 0;\n        border: 4px solid transparent;\n        position: absolute;\n        border-left-color: #707d8b;\n        left: -10px;\n        top: 4px; }\n      .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-tree-item.eruda-expandable.eruda-expanded:before {\n        border-top-color: #707d8b;\n        border-left-color: transparent;\n        left: -12px;\n        top: 6px; }\n    .eruda-dev-tools .eruda-tools .eruda-dom .eruda-dom-tree .eruda-children {\n      padding-left: 15px; }\n  .eruda-dev-tools .eruda-tools .eruda-dom .eruda-inspect {\n    position: absolute;\n    left: 0;\n    bottom: 0;\n    color: #fff;\n    width: 100%;\n    background: #2196f3;\n    display: block;\n    height: 40px;\n    line-height: 40px;\n    text-decoration: none;\n    text-align: center;\n    margin-top: 10px;\n    -webkit-transition: background 0.3s;\n    transition: background 0.3s; }\n    .eruda-dev-tools .eruda-tools .eruda-dom .eruda-inspect:active {\n      background: #1565c0; }\n", ""]);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n    <span class=\"eruda-attribute\">\n      <span class=\"eruda-attribute-name\">"
    + container.escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</span>"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.value : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</span>";
},"2":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "=\"<span class=\"eruda-attribute-value"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.underline : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\">"
  ...
  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.text : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.program(8, data, 0),"data":data})) != null ? stack1 : "")
    + "<span class=\"eruda-html-tag\">&lt;<span class=\"eruda-tag-name\">/"
    + container.escapeExpression(((helper = (helper = helpers.tagName || (depth0 != null ? depth0.tagName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"tagName","hash":{},"data":data}) : helper)))
    + "</span>&gt;</span>\n";
  ...
  return "<span class=\"eruda-toggle-btn\"></span>\n<span class=\"eruda-html-tag\">&lt;<span class=\"eruda-tag-name\">"
    ...
    + "&gt;</span>"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.hasTail : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\"<span class=\"eruda-text-node\">"
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<span class=\"eruda-html-comment\">&lt;!-- "
    + container.escapeExpression(((helper = (helper = helpers.value || (depth0 != null ? depth0.value : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"value","hash":{},"data":data}) : helper)))
    + " --&gt;</span>";
},"useData":true});
