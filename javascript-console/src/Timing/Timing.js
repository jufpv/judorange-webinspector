...
import { evalCss, getFileName, $ } from '../lib/util'


    
    export default class Timing extends Tool {
    ...
    show() {
      ...
      // Scroll management
      super.preventBackgroundScroll('.eruda-scrollcontainer')
      //--
    ...
    _render() {
      ...
      //renderData.showPerformanceDetail = true // this._showPerformanceDetail
